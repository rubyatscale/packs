...
class Packs::Pack
  # source://packs-specification//lib/packs/pack.rb#17
  sig { params(name: ::String, path: ::Pathname, relative_path: ::Pathname).void }
  def initialize(name:, path:, relative_path:); end

  # source://packs-specification//lib/packs/pack.rb#69
  sig { returns(::String) }
  def inspect; end

  # source://packs-specification//lib/packs/pack.rb#55
  sig { returns(T::Boolean) }
  def is_gem?; end

  # source://packs-specification//lib/packs/pack.rb#50
  sig { returns(::String) }
  def last_name; end

  # source://packs-specification//lib/packs/pack.rb#60
  sig { returns(T::Hash[T.untyped, T.untyped]) }
  def metadata; end

  # source://packs-specification//lib/packs/pack.rb#8
  sig { returns(::String) }
  def name; end

  # source://packs-specification//lib/packs/pack.rb#11
  ...
  # source://packs-specification//lib/packs/pack.rb#14
  sig { returns(::Pathname) }
  ...
  # source://packs-specification//lib/packs/pack.rb#65
  sig { returns(T::Array[::Symbol]) }
  def instance_variables_to_inspect; end

  class << self
    # source://packs-specification//lib/packs/pack.rb#26
