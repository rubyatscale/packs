...
module ParsePackwerk
  class << self
    # source://parse_packwerk//lib/parse_packwerk.rb#50
    sig { returns(T::Array[::ParsePackwerk::Package]) }
    def all; end

    # source://parse_packwerk//lib/parse_packwerk.rb#163
    sig { void }
    def bust_cache!; end

    # source://parse_packwerk//lib/parse_packwerk.rb#55
    ...
    # source://parse_packwerk//lib/parse_packwerk.rb#65
    sig { params(file_path: T.any(::Pathname, ::String)).returns(::ParsePackwerk::Package) }
    def package_from_path(file_path); end

    # source://parse_packwerk//lib/parse_packwerk.rb#44
    ...
    # source://parse_packwerk//lib/parse_packwerk.rb#115
    sig do
      params(
    ...
    # source://parse_packwerk//lib/parse_packwerk.rb#76
    sig { params(package: ::ParsePackwerk::Package).void }
    def write_package_yml!(package); end

    # source://parse_packwerk//lib/parse_packwerk.rb#60
    ...
    #
    # source://parse_packwerk//lib/parse_packwerk.rb#151
...
class ParsePackwerk::Package < ::T::Struct
  ...
  # source://parse_packwerk//lib/parse_packwerk/package.rb#71
  ...
  class << self
    ...
    # source://parse_packwerk//lib/parse_packwerk/package.rb#20
